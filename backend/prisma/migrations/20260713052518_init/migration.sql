...
CREATE TABLE "User" (
    ...
    "avatarColor" TEXT NOT NULL DEFAULT '#1C7293',
...
-- AddForeignKey
ALTER TABLE "ContributionLog" ADD CONSTRAINT "ContributionLog_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
